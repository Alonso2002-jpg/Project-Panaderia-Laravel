            ...
            <div class="row gx-lg-5 align-items-center my-5 py-5">
                <div class="col-lg-6 mb-5 mb-lg-0 text-center" style="z-index: 10">
                    <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
                        ...
                        <span style="color: hsl(51,48%,32%)"> Reset your password.</span>
                    </h1>
                        ...
                        <div class="card-body px-4 py-5 px-md-5">
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-outline mb-4 col-md-6">
                                        <input type="password" id="password-confirm" placeholder="***************" name="password_confirmation" class="form-control @error('password-confirm') is-invalid @enderror" />
